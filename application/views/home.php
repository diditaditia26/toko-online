...
<head>
	...
	<!-- Custom-Files -->
	<link href="<?= base_url('electrostore/web/') ?>css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
	<!-- Bootstrap css -->
	<link href="<?= base_url('electrostore/web/') ?>css/style.css" rel="stylesheet" type="text/css" media="all" />
	<!-- Main css -->
	<link rel="stylesheet" href="<?= base_url('electrostore/web/') ?>css/fontawesome-all.css">
	<!-- Font-Awesome-Icons-CSS -->
	<link href="<?= base_url('electrostore/web/') ?>css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
	<!-- pop-up-box -->
	<link href="<?= base_url('electrostore/web/') ?>css/menu.css" rel="stylesheet" type="text/css" media="all" />
	<!-- menu style -->
	<!-- //Custom-Files -->
...
<body>
	...
	<!-- scroll seller -->
	<script src="<?= base_url('electrostore/web/') ?>js/scroll.js"></script>
	<!-- //scroll seller -->

	<!-- smoothscroll -->
	<script src="<?= base_url('electrostore/web/') ?>js/SmoothScroll.min.js"></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src="<?= base_url('electrostore/web/') ?>js/move-top.js"></script>
	<script src="<?= base_url('electrostore/web/') ?>js/easing.js"></script>
	<script>
	...
	<script src="<?= base_url('electrostore/web/') ?>js/bootstrap.js"></script>
	<!-- //for bootstrap working -->
	<!-- //js-files -->
</body>
